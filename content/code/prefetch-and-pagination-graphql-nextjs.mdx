---
title: "UseSWR prefetch, pagination and search example."
description: "Code for prefetching and statically generating a page then taking over with useSWR for pagination and search on client side."
